...
public class ImageBasedScreenObject implements Collidable {
    ...
    public void setAnimationParameters() {
        animationParameters = new AnimationParameters(getWidth(), getHeight(), null, null, null, 0);
    }
    ...
    int[] frameSequenceRun, float delay) {
        animationParameters = new AnimationParameters(frameWidth, frameHeight, null, frameSequenceRun, null, delay);
        initBoundingPolygon();
        centerOriginGeometrically();
    }
    public void setAnimationParameters(float frameWidth, float frameHeight, 
    int[] frameSequenceIdle, int[] frameSequenceRun, int[] frameSequenceJump, float delay) {
        animationParameters = new AnimationParameters(frameWidth, frameHeight, frameSequenceIdle, frameSequenceRun, frameSequenceJump, delay);
        initBoundingPolygon();
        centerOriginGeometrically();
    }
    ...
    public int idleGetDrawStartX() {
        return animationParameters.idleGetDrawStartX();
    }
    public int idleGetDrawStartY() {
        return animationParameters.idleGetDrawStartY();
    }
    public int runGetDrawStartX() {
        return animationParameters.runGetDrawStartX();
    }
    public int runGetDrawStartY() {
        return animationParameters.runGetDrawStartY();
    }
    public int jumpGetDrawStartX() {
        return animationParameters.jumpGetDrawStartX();
    }
    public int jumpGetDrawStartY() {
        return animationParameters.jumpGetDrawStartY();
    }
